  ...
  return (
    <section className="hero">
      ...
      <div className="container section">
        <SectionTitle badge="Positioning" title="Why IML matters" text="The platform frames interoperability as a strategic bridge between policy, architecture, trust and measurable system performance." />
        <div className="tile-grid three-up">
          {[
            { title: "For policymakers", text: "A clear executive view of national interoperability maturity, readiness gaps and priority actions." },
            { title: "For institutions", text: "A common language to align architecture, governance, identity, trust and deployment decisions." },
            { title: "For implementers", text: "A way to position technical components inside a coherent and scalable national roadmap." },
          ].map((item) => (
            <Card key={item.title} className="value-card">
              <div className="metric-symbol">{item.title.slice(0, 2).toUpperCase()}</div>
              <h3>{item.title}</h3>
              <p>{item.text}</p>
            </Card>
          ))}
  ...
  return (
    <section className="section">
      <div className="container">
        <SectionTitle badge="" title="A framework that is simple to read and strong enough to defend" text="IML combines six assessment dimensions, a maturity score and comparative country notes, while treating identity and trust as structural conditions rather than optional technical modules." />
        <div className="tile-grid three-up">
          {[
            { title: "Governance & Standards", symbol: "GV", text: "Institutional ownership, legal frameworks, standards governance, accountability and national steering capacity." },
            { title: "Technical Interoperability", symbol: "IO", text: "Exchange models, APIs, semantics, technical integration quality, service continuity and architecture coherence." },
            { title: "Identity & Trust", symbol: "ID", text: "Identity matching, authentication, consent, provider and patient identification, and trust services." },
            { title: "Security", symbol: "SC", text: "Privacy safeguards, access control, traceability, cyber readiness and defensible trust practices." },
            { title: "Adoption", symbol: "AD", text: "Operational rollout, user uptake, field deployment, integration into workflows and implementation depth." },
            { title: "Correction & Feedback", symbol: "CF", text: "Redress, correction, complaint handling, recourse pathways and institutional learning from failures." },
          ].map((pillar) => (
...
function Id4dPage() {
  return (
    <section className="section">
      <div className="container">
        <SectionTitle badge="Identity infrastructure" title="Positioning IML in alignment with the ID4D approach" text="IML can be aligned with ID4D by treating digital identity as an enabling public infrastructure layer for inclusive access, trusted service delivery, interoperability and accountable governance." />
        <Card className="soft-card">
          <div className="content-block">
            <h3>Identity and trust as a public infrastructure layer</h3>
            <p>Within the ID4D framing, identity is not a side module. It is one of the enabling layers that determine whether access, exchange, accountability and trusted service delivery can function at scale across health systems.</p>
            <h3>Why identity belongs inside the ID4D reading</h3>
            ...
            <p>IML therefore treats identity, authentication, consent and auditability as structural variables rather than optional technical add-ons.</p>
            <h3>Explanatory note on the proposed identity code</h3>
            <p>The proposed request-validated identity code is presented here as a methodological annex, not as a universal civil identifier.</p>
            <div className="code-box mono">
              VISIBLE FORMAT
              <br />
              IML1-S-DDMMYYYY-GEO4-SSSS-CC
              <br />
              Example: IML1-2-17041986-Q7L2-0421-58
            </div>
          </div>
        </Card>
        <div className="tile-grid three-up top-gap">
          {[
            { title: "Inclusive access", text: "Assesses whether people can realistically enter the health system and use digital services without being blocked by identity gaps." },
            { title: "Low-friction service entry", text: "Examines how easily users and institutions can access services and move across care pathways without duplicative burden." },
            { title: "Trusted identity assurance", text: "Covers identification, authentication, matching quality and reliability of trust services." },
            { title: "Interoperability and open standards", text: "Looks at exchange architecture, shared standards and practical ability of systems to connect." },
            { title: "Privacy and data protection", text: "Focuses on purpose limitation, lawful access, minimisation and confidentiality." },
            { title: "Governance, oversight and redress", text: "Evaluates accountability, supervision, complaint handling, correction capacity and public-interest learning." },
          ].map((item) => (
            <Card key={item.title} className="value-card">
              <div className="metric-symbol">{item.title.slice(0, 2).toUpperCase()}</div>
              <h3>{item.title}</h3>
...
function EvaluationPage() {
  return (
    <section className="section">
      <div className="container">
        <SectionTitle badge="" title="Evaluation and regulatory shifts in an interoperable environment" text="Interoperability maturity affects clinical evaluation, long-term follow-up and regulatory decision-making by making broader, longitudinal and better-governed evidence environments possible." />
        <Card className="soft-card">
          <div className="content-block">
            <h3>Illustrative progression scale</h3>
            <div className="stack-list">
              <div className="list-box"><strong>20%</strong> · Fragmented observation. Evidence remains episodic, disconnected and difficult to compare across settings.</div>
              <div className="list-box"><strong>40%</strong> · Partial visibility. Some structured follow-up exists, but interoperability remains too uneven for stable longitudinal reading.</div>
              <div className="list-box"><strong>50%</strong> · Transitional threshold. Regulatory and clinical use can begin to expand, but comparability, traceability and continuity are still incomplete.</div>
              <div className="list-box"><strong>60%</strong> · Structured follow-up. Interoperability becomes usable for broader post-authorization observation and more consistent real-world evidence.</div>
              <div className="list-box"><strong>80%</strong> · Advanced continuity. Cross-setting evidence becomes more legible, more regulator-grade and more useful for long-term monitoring.</div>
              <div className="list-box"><strong>100%</strong> · Mature integrated horizon. Evaluation approaches a governed continuum where authorization is one stage within a longer supervised clinical knowledge cycle.</div>
            </div>
          </div>
        </Card>
        <div className="split-grid top-gap">
          <Card>
            <div className="content-block">
              ...
              <p>This does not mean creating a single uncontrolled profile. It means enabling authorised and proportionate access to the information needed to understand medicines use in real care pathways.</p>
            </div>
          </Card>
          <Card className="soft-card">
            <div className="content-block">
              <h3>Why Nordic reference cases matter here</h3>
              <p>Sweden shows the practical value of a shared medication information layer through the National Medication List.</p>
              <p>Denmark offers a complementary example in bacteriology with MiBa and MiBAlert, where cross-sector microbiology access influences isolation decisions, antibiotic choice and infection-control action.</p>
            </div>
          </Card>
        </div>
        <Card className="highlight-card top-gap">
          <div className="content-block">
            <h3>Special note for pharmaceutical industry and regulatory authorities</h3>
...
function WorldTooltip({ marker, country, onEnter, onLeave }) {
  ...
  return (
    <div className="tooltip-anchor" style={{ left, top, transform: `${horizontal}${vertical}` }} onMouseEnter={onEnter} onMouseLeave={onLeave}>
...
function WorldPage() {
  ...
  return (
    <section className="section">
      <div className="container">
        <SectionTitle badge="Country notes" title="A growing global review rather than a closed country list" text="The countries currently included in the study are not presented as a fixed or exhaustive panel. They are analysed progressively, in a partly opportunistic sequence, with the longer-term objective of extending the review to as many countries as possible." />
        <Card className="soft-card">
          <div className="content-block">
            <h3>Reading guide for score ranges</h3>
            <div className="tile-grid">
              {[
                { range: "0-39%", title: "Foundational stage", text: "Very limited interoperability maturity. Core structures, exchange routines and trust mechanisms remain fragmented or embryonic." },
                { range: "40-59%", title: "Emerging stage", text: "A visible trajectory exists, but operational continuity remains uneven and several core layers are still incomplete." },
                { range: "60-79%", title: "Structured stage", text: "The system shows a coherent interoperability architecture with meaningful deployment, while important gaps still affect scale or consistency." },
                { range: "80-100%", title: "Advanced stage", text: "Interoperability is broadly structured, operational and legible, with stronger continuity across identity, governance, exchange and real use." },
              ].map((item) => (
...
function ContactPage() {
  ...
  return (
    <section className="section">
      <div className="container">
        <SectionTitle badge="" title="Editorial and institutional contact" text="For publication matters, country notes, methodological discussion and institutional exchanges, please use the form below or the direct contact details." />
        <div className="split-grid profile-grid">
          <Card>
            <div className="content-block">
              <h3>Contact form</h3>
              <form className="contact-form" action={CONTACT_FORM_ACTION} method="POST">
                ...
                <div className="form-grid">
                  ...
                  <label>
                    Email
                    <input name="email" placeholder="name@organisation.org" type="email" required />
                  </label>
                </div>
                <label>
                  Organisation
                  <input name="organisation" placeholder="Institution, ministry, donor, provider, insurer..." />
                </label>
                <label>
                  Message
                  <textarea name="message" placeholder="Describe your request or the update you want to discuss." rows="6" required />
                </label>
