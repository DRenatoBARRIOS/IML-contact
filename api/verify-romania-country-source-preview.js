...
export async function GET() {
  if (process.env.VERCEL_ENV !== "preview" || process.env.VERCEL_GIT_COMMIT_REF !== "fix-romania-country-specific-source") {
  ...
  try {
    ...
    return Response.json(
      { error: "Romania country-source preview verification failed.", detail: error?.message || String(error) },
